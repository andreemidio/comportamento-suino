...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        self.setStyleSheet(
            "QMainWindow{background-color:#31363b} QWidget{background-color:#31363b;font-family: \"Aldrich\"; font-size: 18pt; color:#FFFFFF} QGraphicsView{background-color:#232629}")
        ...
        self.headerLayout.addItem(
            QtWidgets.QSpacerItem(10, 10, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum))
        ...
        self.headerLayout.addItem(
            QtWidgets.QSpacerItem(20, 10, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum))
